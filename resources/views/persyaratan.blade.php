            ...
            <div class="col-12">
                ...
                <div class="card mb-5 shadow-sm border-0">
                    <div class="card-header bg-warning text-dark py-3">
                        <h3 class="card-title mb-0">
                            <i class="fas fa-star me-2"></i>Ketentuan Persyaratan Khusus
                        </h3>
                    </div>
                    <div class="card-body p-0">
                        <div class="row g-0">
                            <!-- Beasiswa Daerah Operasional -->
                            <div id="beasiswa-daerah" class="col-lg-6">
                                <div class="h-100 p-4 border-end">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-box bg-success text-white rounded-circle p-2 me-3">
                                            <i class="fas fa-map-marker-alt"></i>
                                        </div>
                                        <h5 class="mb-0 text-success">Beasiswa Daerah Operasional</h5>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-success me-2"></i>
                                            Berdomisili di wilayah sekitar operasional PT Antam, Tbk
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-success me-2"></i>
                                            Rata-rata nilai rapor minimal <strong>75</strong>
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-success me-2"></i>
                                            Dibuktikan dengan KTP dan/atau Kartu Keluarga (KK)
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="h-100 p-4">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <h5 class="mb-0 text-primary">Beasiswa Prestasi Akademik</h5>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-primary me-2"></i>
                                            Rata-rata nilai rapor minimal <strong>85</strong>
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-primary me-2"></i>
                        ...
                        <div class="row g-0 border-top">
                            ...
                            <div id="beasiswa-prestasi" class="col-lg-6">
                                <div class="h-100 p-4 border-end">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-box bg-info text-white rounded-circle p-2 me-3">
                                            <i class="fas fa-trophy"></i>
                                        </div>
                                        <h5 class="mb-0 text-info">Beasiswa Prestasi Non-Akademik</h5>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                        ...
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-info me-2"></i>
                                            Bidang: seni, agama, budaya, olahraga, atau teknologi
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-info me-2"></i>
                                            Rata-rata nilai rapor minimal <strong>80</strong>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="beasiswa-kurang-mampu" class="col-lg-6">
                                <div class="h-100 p-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-box bg-warning text-dark rounded-circle p-2 me-3">
                                            <i class="fas fa-hands-helping"></i>
                                        </div>
                                        <h5 class="mb-0 text-warning">Beasiswa Kurang Mampu</h5>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-warning me-2"></i>
                                            Keluarga dengan kondisi ekonomi tidak mampu
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-warning me-2"></i>
                                            Surat keterangan dari RT/RW atau sekolah
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-arrow-right text-warning me-2"></i>
                                            Rata-rata nilai rapor minimal <strong>75</strong>
