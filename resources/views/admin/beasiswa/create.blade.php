                ...
                <div class="card shadow-lg border-0">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <small class="text-muted">
                                        <i class="fas fa-calendar-alt me-1"></i>Batas pendaftaran:
                                ...
                                <div class="scholarship-amount">
                                    <span class="badge bg-success-custom px-3 py-2">
                                        <i class="fas fa-money-bill-wave me-1"></i>Rp
                    ...
                    @else
                        <div class="card-header py-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1">
                                        <i class="fas fa-trophy text-warning me-2"></i>Pendaftaran Beasiswa
                                    </h4>
                                    <small class="text-muted">
                                        <i class="fas fa-info-circle me-1"></i>Data beasiswa tidak tersedia
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="form-section">
                            ...
                            <form method="POST"
                                action="{{ isset($beasiswa) ? route('pendaftar.store', $beasiswa) : route('pendaftar.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="nim" name="nim" value="{{ old('nim') }}" placeholder="Masukkan NIM"
                                                    pattern="[0-9]+" title="NIM hanya boleh berisi angka" required>
                                                @error('nim')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    title="Nomor HP hanya boleh berisi angka (10-15 digit)" required>
                                                @error('no_hp')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-group-section mb-4">
                                    ...
                                    <div class="form-group-content">
                                        <div class="mb-3">
                                            ...
                                            <textarea
                                                class="form-control modern-textarea @error('alasan_mendaftar') is-invalid @enderror"
                                            ...
                                            <div class="form-text">
                                                ...
                                                Jelaskan secara detail mengapa Anda layak mendapatkan beasiswa ini (minimal
                                                50 karakter)
                                            </div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="file-upload-card">
                                                    ...
                                                    <input type="file"
                                                        ...
                                                        id="file_transkrip" name="file_transkrip" accept=".pdf" required>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="file-upload-card">
                                                    ...
                                                    <input type="file"
                                                        ...
                                                        id="file_kk" name="file_kk" accept=".pdf,.jpg,.jpeg,.png" required>
                                                    @error('file_kk')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="form-group-section">
                                    ...
                                    <div
                                        class="d-flex flex-column flex-md-row gap-3 justify-content-between align-items-center">
                                        <div class="form-info">
                                            <small class="text-muted">
